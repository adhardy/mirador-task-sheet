...
A web app is available to assist selection:

\url{https://share.streamlit.io/adhardy/postcode-component-analysis-web-app/main}

This best used in conjunction with the above plots to first choose a region of interest, and then using the app to explore the data in more detail.
